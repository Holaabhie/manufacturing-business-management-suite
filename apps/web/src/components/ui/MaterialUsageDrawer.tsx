...
const STATUS_CONFIG: Record<string, { colorClass: string; bgClass: string; label: string; dot: string; color: string; bg: string }> = {
    completed: { colorClass: "text-[#059669] dark:text-[#34D399]", bgClass: "bg-[rgba(5,150,105,0.12)] dark:bg-[rgba(52,211,153,0.12)]", label: "Completed", dot: "#34D399", color: "#34D399", bg: "rgba(52,211,153,0.12)" },
    in_progress: { colorClass: "text-[#D97706] dark:text-[#FBBF24]", bgClass: "bg-[rgba(217,119,6,0.12)] dark:bg-[rgba(251,191,36,0.12)]", label: "In Progress", dot: "#FBBF24", color: "#FBBF24", bg: "rgba(251,191,36,0.12)" },
    processing: { colorClass: "text-[#2563EB] dark:text-[#60A5FA]", bgClass: "bg-[rgba(37,99,235,0.12)] dark:bg-[rgba(96,165,250,0.12)]", label: "In Production", dot: "#60A5FA", color: "#60A5FA", bg: "rgba(96,165,250,0.12)" },
    pending: { colorClass: "text-[#2563EB] dark:text-[#60A5FA]", bgClass: "bg-[rgba(37,99,235,0.12)] dark:bg-[rgba(96,165,250,0.12)]", label: "Pending", dot: "#60A5FA", color: "#60A5FA", bg: "rgba(96,165,250,0.12)" },
    cancelled: { colorClass: "text-[#DC2626] dark:text-[#F87171]", bgClass: "bg-[rgba(220,38,38,0.12)] dark:bg-[rgba(248,113,113,0.12)]", label: "Cancelled", dot: "#F87171", color: "#F87171", bg: "rgba(248,113,113,0.12)" },
};
                    ...
                    >
                        ...
                        <div className="flex items-center justify-between px-5 py-4 border-b border-[var(--border)]">
                            <div className="flex items-center gap-3 min-w-0">
                                <div className="w-[40px] h-[40px] rounded-[10px] flex items-center justify-center flex-shrink-0 bg-[rgba(37,99,235,0.1)] dark:bg-[rgba(96,165,250,0.1)]">
                                    <Package className="h-[18px] w-[18px] text-[#2563EB] dark:text-blue-400" />
                                </div>
                            ...
                            {loading ? (
                                <div className="space-y-3">
                                    {Array.from({ length: 4 }).map((_, i) => (
                                        <div key={i} className="h-[60px] rounded-[12px] shimmer bg-[var(--muted)]" />
                                    ))}
                                </div>
                            ) : (
                                <>
                                        ...
                                        {[
                                            ...
                                            >
                                                <div className="flex items-center gap-2 mb-1.5">
                                                    ...
                                                    <span className="text-[11px] text-[#64748B] dark:text-white/40 uppercase tracking-wider font-medium">{s.label}</span>
                                                </div>
                                                <span className="text-[18px] font-bold text-[#0F172A] dark:text-white block" style={{ fontVariantNumeric: "tabular-nums" }}>
                                                    {s.value}
                                                </span>
                                            </div>
                                        ))}
                                    ...
                                    <div className="flex gap-1.5 overflow-x-auto pb-1" style={{ scrollbarWidth: "none" }}>
                                        {filters.map(f => (
                                            <button
                                                ...
                                                style={{
                                                    background: filter === f.key ? "#1D9E75" : undefined,
                                                }}
                                            >
                                                {f.label}
                                                {f.key !== "all" && (
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                ...
                                                                <div className="flex items-start justify-between gap-2">
                                                                    <div className="min-w-0">
                                                                        <span className="text-[10px] text-[#64748B] dark:text-white/30 uppercase tracking-wider font-medium block">
                                                                    ...
                                                                    <div className="text-right flex-shrink-0">
                                                                        ...
                                                                        <span className="text-[11px] text-[#64748B] dark:text-white/40">{log.unit || material?.unit}</span>
                                                                        <div className="mt-1">
                                                                            <span
                                                                                className={cn(
