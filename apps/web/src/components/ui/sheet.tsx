  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          "data-[state=open]:animate-in data-[state=closed]:animate-out fixed z-[1001] flex flex-col gap-4 transition-transform ease-in-out data-[state=closed]:duration-[220ms] data-[state=open]:duration-[280ms]",
          side === "right" &&
          ...
          side === "bottom" &&
            "data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom inset-x-0 bottom-0 h-[100dvh] max-h-[100dvh]",
          className
        )}
        style={{
      ...
      >
        ...
        <SheetPrimitive.Close
          className="focus:ring-2 focus:ring-[var(--overlay-accent)] focus:ring-offset-2 absolute top-4 right-4 z-10 rounded-full w-8 h-8 flex items-center justify-center opacity-70 transition-all duration-150 ease hover:opacity-100 hover:bg-[var(--overlay-hover)] focus:outline-hidden disabled:pointer-events-none"
