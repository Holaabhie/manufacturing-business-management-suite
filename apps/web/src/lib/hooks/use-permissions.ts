...
interface PermissionContextValue {
    ...
    // Refresh permissions (e.g., after Admin updates them)
...
export function usePermissions(): PermissionContextValue {
    ...
    if (!context) {
        // Fallback for components not wrapped in PermissionProvider
        // (e.g., old code that doesn't use the provider yet)
...
/**
 * Fallback hook for when PermissionProvider is not available.
 * Uses the old /api/auth/me approach directly.
 */
