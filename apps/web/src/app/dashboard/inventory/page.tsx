    ...
    <motion.div variants={staggerContainer} initial="initial" animate="animate" className="space-y-6">
      ...
      {viewMode === "table" && (
        <>
          ...
          <motion.div variants={staggerItem} className="flex items-center space-x-2">
            ...
            <span className="text-[13px] text-[var(--label-tertiary)]">{filteredItems.length} items</span>
          </motion.div>
              ...
              <Table>
                <TableHeader>
                  <TableRow className="glass-table-header hover:bg-transparent border-b border-white/[0.07] dark:border-white/[0.07]">
                    <TableHead className="font-semibold py-3 text-[13px] text-[var(--label-secondary)] uppercase tracking-wide pl-5">Item & Supplier</TableHead>
                    <TableHead className="font-semibold py-3 text-[13px] text-[var(--label-secondary)] uppercase tracking-wide">Stock Level</TableHead>
                    <TableHead className="font-semibold py-3 text-[13px] text-[var(--label-secondary)] uppercase tracking-wide">Unit Cost (Landed)</TableHead>
                    <TableHead className="font-semibold py-3 text-[13px] text-[var(--label-secondary)] uppercase tracking-wide">Status</TableHead>
                        ...
                        {searchTerm ? (
                          <div className="flex flex-col items-center gap-3 py-16">
                            <div className="w-[56px] h-[56px] rounded-[14px] bg-[var(--fill-tertiary)] flex items-center justify-center">
                              <Package className="h-6 w-6 text-[var(--label-tertiary)]" />
                            </div>
                            <p className="text-[17px] font-medium text-[var(--label-secondary)]">No materials found</p>
                            <p className="text-[13px] text-[var(--label-tertiary)]">Try a different search term</p>
                          </div>
                        ) : (
                          <EmptyState
                            icon="📦"
                      ...
                      return (
                        ...
                        >
                          <TableCell className="py-3.5 pl-5">
                            <div className="flex items-center gap-3">
                              <div className={cn(
                                ...
                                isLowStock ? "bg-[rgba(255,59,48,0.1)]" : "bg-[var(--fill-tertiary)]"
                              )}>
                                <Package className={cn("h-[18px] w-[18px]", isLowStock ? "text-[var(--ios-red)]" : "text-[var(--label-secondary)]")} />
                              </div>
                              <div>
                                <span className="text-[15px] font-semibold text-[var(--label-primary)] block leading-[20px]">{item.name}</span>
                                <div className="flex items-center text-[13px] text-[var(--ios-blue)] font-medium mt-0.5">
                          ...
                          <TableCell className="py-3.5">
                            <span className="text-[17px] font-bold text-[var(--label-primary)] block">{item.quantity} {item.unit}</span>
                            <span className="text-[11px] text-[var(--label-tertiary)] uppercase tracking-wide">Min: {item.min_stock_level} {item.unit}</span>
                          </TableCell>
                          <TableCell className="py-3.5">
                          ...
                          <TableCell className="py-3.5">
                            {isLowStock ? (
                              <IOSBadge color="red" variant="tinted" dot size="medium">RESTOCK</IOSBadge>
                            ) : (
                              <IOSBadge color="green" variant="tinted" dot size="medium">In Stock</IOSBadge>
                            )}
                          </TableCell>
                            ...
                            <div className="flex items-center justify-end gap-2">
                              {isLowStock && (
                                <IOSButton
                                  ...
                                  className="bg-[var(--ios-green)] hover:bg-[#2DB84E]"
                                >
                                  Restock
                                </IOSButton>
                              )}
        ...
        >
          ...
          {forecastLoading ? (
            ...
            <div className="flex flex-col items-center justify-center py-16">
              <div className="w-[56px] h-[56px] rounded-[14px] bg-[var(--fill-tertiary)] flex items-center justify-center mb-3">
                <Activity className="h-6 w-6 text-[var(--label-tertiary)]" />
              </div>
              <p className="text-[17px] font-medium text-[var(--label-secondary)]">No forecast data</p>
              <p className="text-[13px] text-[var(--label-tertiary)]">Add inventory items and create orders to generate forecasts</p>
            </div>
          )}
        </motion.div>
      )}
            ...
            <div className="p-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-4 pt-4">
                <div className="space-y-1.5">
                  <Label htmlFor="name" className="text-[13px] text-[var(--label-secondary)]">Material Name *</Label>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    <Label htmlFor="quantity" className="text-[13px] text-[var(--label-secondary)]">Stock Quantity</Label>
                  ...
                  <div className="space-y-1.5">
                    <Label htmlFor="unit" className="text-[13px] text-[var(--label-secondary)]">Unit</Label>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    <Label htmlFor="min_stock" className="text-[13px] text-[var(--label-secondary)]">Low Stock Alert</Label>
                  ...
                  <div className="space-y-1.5">
                    <Label htmlFor="cost" className="text-[13px] text-[var(--label-secondary)]">Landing Cost / Unit</Label>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    <Label htmlFor="hsn" className="text-[13px] text-[var(--label-secondary)]">HSN Code</Label>
                  ...
                  <div className="space-y-1.5">
                    <Label htmlFor="tax" className="text-[13px] text-[var(--label-secondary)]">Tax/GST %</Label>
                ...
                <div className="space-y-1.5">
                  <Label htmlFor="whatsapp" className="text-[13px] text-[var(--ios-blue)] font-bold">Supplier WhatsApp *</Label>
      ...
      <Dialog open={isDeleteDialogOpenConfirm} onOpenChange={setIsDeleteDialogOpenConfirm}>
        <DialogContent className="max-w-[350px] rounded-[24px] border-white/10 glass-dialog">
          <DialogHeader>
            <DialogTitle className="text-[20px] font-bold text-[var(--label-primary)]">Delete Material</DialogTitle>
            <DialogDescription className="text-[15px] text-[var(--label-secondary)]">
              Are you sure you want to remove this item? This action cannot be undone.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter className="flex gap-2">
            <IOSButton variant="gray" size="large" onClick={() => setIsDeleteDialogOpenConfirm(false)} fullWidth>
              Cancel
            </IOSButton>
            <IOSButton variant="destructive" size="large" onClick={() => itemToDeleteId && handleDelete(itemToDeleteId)} fullWidth>
              Delete
            </IOSButton>
          </DialogFooter>
        </DialogContent>
